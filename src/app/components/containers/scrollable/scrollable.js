...
export default class Scrollable extends Component {
  ...
  resizeScrollbar() {
    ...
    let scrollOffset = $(this.container)[this.scrollOffsetAttr]()
    let scrollbarSize = $(this.track)[this.sizeAttr]()
  ...
  render() {
    return (
      <div>
        <section ref="container" class="scrollable-container">
          <div ref="contents" class="contents">
            <slot></slot>
          </div>
        </section>

        <section ref="track" class="track">
          <span ref="scrollbar" class="scrollbar"></span>
        </section>
      </div>
    )
  }
